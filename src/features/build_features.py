...
def extract_valid_package_rate(entries,raw_path):
    '''
    return a dictionary which contains basic stats of one network-stats record.
    
    :param: temp: a cleaned groupby dataframe generated by clean_data
    '''
    feature = []
    for i in entries:
        temp = raw_path +"/"+ i
...
def features_build(indir,outdir,output):
    ...
    :param: output: whether this function output the table or not, 1 means output, 0 means not
    '''
