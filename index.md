...
## Data Cleaning
When running network-stats to collect data, this is what the dataset looks like with the columns given. The IP's and Port's have been anonymized for this example for privacy reasons.
